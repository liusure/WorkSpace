  ...
  <el-card>
    <el-tabs v-model="activeName">
      <el-tab-pane label="基本信息" name="basic">
        <basic-info-form ref="basicInfo" :info="info" :tableTypeOptions="tableTypeOptions" :statusOptions="statusOptions" />
      </el-tab-pane>
      <el-tab-pane label="字段信息" name="cloum">
        <el-table ref="dragTable" :data="cloumns" row-key="columnId" :max-height="tableHeight">
          ...
          />
          <el-table-column label="列描述" min-width="10%">
          ...
          <el-table-column label="列类型" min-width="11%">
            <template slot-scope="scope">
...
<script>
  import {  getTable, updateTable } from "@/api/apaas/table";
  ...
  export default {
    ...
    methods: {
      ...
      close() {
        ...
        this.$router.push({ path: "/apaas/datasource/table/"+this.info.dsId, query: { t: Date.now()}})
      }
    },
    mounted() {
