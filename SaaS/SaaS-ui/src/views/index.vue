      ...
      <el-card>
        ...
        <div class="chart-box">
          ...
          <div class="chart-content" v-if="statisticsShow" >
            <line-chart :chart-data="lineChartData"  style="background:#fff;padding:16px 16px 0;margin-bottom:32px;"/>
          </div>
          <div class="card-box">
    ...
    <div class="right">
      <el-card>
        <div class="QR-code">
          ...
          <span class="code-detail">—扫描上方二维码购买终身商业授权—</span>
        </div>
      </el-card>
      <el-card title="入门指引" style="marginTop: 13px;">
        <div class="btn-box">
          <div>
      ...
      <el-card title="更新日志" style="marginTop: 13px">
...
<script>
  import { dashboardData, lineChat, tenantIndex } from '@/api/dashboard'
