    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
          <el-form-item label="用户名称" prop="search_LIKE_loginName">
            <el-input
              v-model="queryParams.search_LIKE_loginName"
              placeholder="请输入用户名称"
              clearable
              size="small"
              style="width: 240px"
          ...
          <el-form-item label="手机号码" prop="search_LIKE_mobile">
            <el-input
              v-model="queryParams.search_LIKE_mobile"
              placeholder="请输入手机号码"
              clearable
              size="small"
              style="width: 240px"
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="form.id == undefined" label="用户名称" prop="loginName">
              <el-input v-model="form.loginName" placeholder="请输入登陆用户名称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item v-if="form.id == undefined" label="用户密码" prop="plainPassword">
              <el-input v-model="form.plainPassword" placeholder="请输入用户密码" type="password" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
export default {
  ...
  data() {
    return {
      ...
      queryParams: {
        pageNum: 1,
        pageSize: 10,
        search_LIKE_loginName: undefined,
  ...
  created() {
    ...
    this.sexOptions =consts.sexOptions
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listUser(this.addDateRange(this.queryParams, this.dateRange,"createTime_date")).then(response => {
    ...
    handleNodeClick(data) {
      this.queryParams.search_EQ_deptId = data.id;
      this.getList();
    },
    // 用户状态修改
    handleStatusChange(row) {
      ...
      this.$confirm('确认要"' + text + '""' + row.name + '"用户吗?', "警告", {
          ...
          return changeUserStatus(row.id, row.statusFlag);
        }).then(() => {
