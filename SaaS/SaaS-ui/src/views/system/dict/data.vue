<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="字典名称" prop="search_EQ_dictType">
        <el-select v-model="queryParams.search_EQ_dictType" size="small">
          <el-option
      ...
      <el-form-item label="字典标签" prop="search_LIKE_dictLabel">
        <el-input
          v-model="queryParams.search_LIKE_dictLabel"
          placeholder="请输入字典标签"
          clearable
          size="small"
  ...
  data() {
    return {
      ...
      queryParams: {
        pageNum: 1,
        pageSize: 10,
        search_LIKE_dictName: undefined,
  ...
  methods: {
    ...
    getType(dictId) {
      getType(dictId).then(response => {
        this.queryParams.search_EQ_dictType = response.data.dictType;
    ...
    resetQuery() {
      ...
      this.queryParams.search_EQ_dictType = this.defaultDictType;
      this.handleQuery();
    },
    /** 新增按钮操作 */
    handleAdd() {
      ...
      this.open = true;
      this.title = "添加字典数据";
      this.form.dictType = this.queryParams.search_EQ_dictType;
    },
    // 多选框选中数据
