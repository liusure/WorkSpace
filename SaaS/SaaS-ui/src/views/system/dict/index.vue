<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="字典名称" prop="search_LIKE_dictName">
        <el-input
          v-model="queryParams.search_LIKE_dictName"
          placeholder="请输入字典名称"
          clearable
          size="small"
          style="width: 240px"
      ...
      <el-form-item label="字典类型" prop="search_LIKE_dictType">
        <el-input
          v-model="queryParams.search_LIKE_dictType"
          placeholder="请输入字典类型"
          clearable
          size="small"
          style="width: 240px"
...
export default {
  ...
  data() {
    return {
      ...
      queryParams: {
        ...
        search_LIKE_dictType: undefined,
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listType(this.addDateRange(this.queryParams, this.dateRange,"createTime_date")).then(response => {
