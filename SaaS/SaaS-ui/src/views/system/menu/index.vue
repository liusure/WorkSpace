  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch">
      <el-form-item label="菜单名称" prop="menuName">
        <el-input
          v-model="queryParams.search_LIKE_menuName"
          placeholder="请输入菜单名称"
          clearable
          size="small"
      ...
      <el-form-item label="状态" prop="status">
        <el-select v-model="queryParams.search_EQ_statusFlag" placeholder="菜单状态" clearable size="small">
          <el-option
    ...
    >
      ...
      <el-table-column prop="statusFlag" label="状态" :formatter="statusFormat" width="80"></el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      // 查询参数
      queryParams: {
        search_LIKE_menuName: undefined,
        search_EQ_statusFlag: undefined,
        sort:"asc_parentId,asc_orderNum"
      },
      // 表单参数
      form: {},
      // 表单校验
  ...
  created() {
    ...
    this.visibleOptions =consts.visibleOptions;
