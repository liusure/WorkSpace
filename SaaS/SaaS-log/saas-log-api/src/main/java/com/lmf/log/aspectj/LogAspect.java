...
import com.saas.log.event.SysOperLogEvent;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.saas.log.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult)
    {
        try
        {
            ...
            // 获取当前的用户
            SysUser loginUser = UserContextHolder.getCurrentUser();
           ...
           // AsyncManager.me().execute(AsyncFactory.recordOper(operLog));
            SpringUtils.publishEvent(new SysOperLogEvent(operLog));
        }
        catch (Exception exp)
        {
            // 记录本地异常日志
