...
import com.saas.common.util.CamelCaseUtils;
...
public class VelocityUtils
{
    ...
    public static String getFileName(String template, GenTable genTable)
    {
        ...
        {
            fileName = String.format("%s/repository/%sDao.java", javaPath, className);
        }               
    ...
    {
        if (null != paramsObj && paramsObj.containsKey(GenConstants.PARENT_MENU_ID))
        {
    ...
    public static String getTreecode(JSONObject paramsObj)
    {
        ...
        {
            return CamelCaseUtils.toCamelCase(paramsObj.getString(GenConstants.TREE_CODE));
        }
    ...
    public static String getTreeParentCode(JSONObject paramsObj)
    {
        if (paramsObj.containsKey(GenConstants.TREE_PARENT_CODE))
        {
            return CamelCaseUtils.toCamelCase(paramsObj.getString(GenConstants.TREE_PARENT_CODE));
        }
        return StringUtils.EMPTY;
    }
    ...
    public static String getTreeName(JSONObject paramsObj)
    {
        if (paramsObj.containsKey(GenConstants.TREE_NAME))
        {
            return CamelCaseUtils.toCamelCase(paramsObj.getString(GenConstants.TREE_NAME));
        }
        return StringUtils.EMPTY;
    }
