...
public class GenUtils {
    ...
    public static void initTable(GenTable genTable, Long operId) {
        ...
        genTable.setCreateUserId(operId);
    }
    ...
    public static void initColumnField(GenTableColumn column, GenTable table) {
        ...
        column.setCreateUserId(table.getCreateUserId());
        // 设置java字段名
        column.setJavaField(CamelCaseUtils.toCamelCase(columnName));
        // 设置默认类型
    ...
    public static String convertClassName(String tableName) {
        ...
        return CamelCaseUtils.convertToCamelCase(tableName);
    }
