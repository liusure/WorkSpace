...
public class SysPrivilegeController extends BaseController {
	 ...
	 * 获取通知公告列表
	 */
	@PreAuthorize("@ss.hasPermi('system:privilege:list')")
	@GetMapping("/list")
	 ...
	 * 根据通知公告编号获取详细信息
	 */
	@PreAuthorize("@ss.hasPermi('system:privilege:query')")
	 ...
	 * 新增通知公告
	 */
	@PreAuthorize("@ss.hasPermi('system:privilege:add')")
	 ...
	 * 修改通知公告
	 */
	@PreAuthorize("@ss.hasPermi('system:privilege:edit')")
	 ...
	 * 删除通知公告
	 */
	@PreAuthorize("@ss.hasPermi('system:privilege:remove')")
